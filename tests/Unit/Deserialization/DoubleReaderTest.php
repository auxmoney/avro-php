...
class DoubleReaderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->reader = new DoubleReader($this->decoder);
    }
    ...
    {
        $expectedValue = 1.7976931348623157E+308; // PHP_FLOAT_MAX
    ...
    public function testReadWithSmallValue(): void
    {
        $expectedValue = 2.2250738585072014E-308; // PHP_FLOAT_MIN
